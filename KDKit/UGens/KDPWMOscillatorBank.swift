...
class KDPWMOscillatorBank: KDInstrument {

    private(set) var oscillators: AKPWMOscillatorBank = AKPWMOscillatorBank()
    ...
    var pulseWidth: Double {
        ...
        set (value) {
            ...
            self.oscillators.pulseWidth = value
        }
    }
...
// //////////////////////////////
    ...
    convenience init(pulseWidth: Double = 0, _ adsr: ADSR = ADSR.defaultShort()) {
        self.init()
        self.adsr = adsr
...
// //////////////////////////////
    ...
    private func connect() {
        self.oscillators = AKPWMOscillatorBank()
