...
class KDSynthSnare: KDInstrument {

    private(set) var instrument: AKSynthSnare = AKSynthSnare()
...
// //////////////////////////////
    ...
    func setMidiNote(_ midiNote: MIDINoteNumber) {
        self.midiNote = midiNote
    }

    func setDefaultVelocity(_ velocity: MIDIVelocity) {
        self.defaultVelocity = velocity
    }

    private func connect() {
        self.instrument = AKSynthSnare()
...
// //////////////////////////////
    ...
    func play() {
        ...
        self.instrument.play(noteNumber: self.midiNote, velocity: self.defaultVelocity, channel: 1)
        self.envelope.start()
    }
