...
class KDTubularBells: KDInstrument {

    private(set) var instrument: AKTubularBells = AKTubularBells()
...
// //////////////////////////////
    ...
    private func connect() {
        self.instrument = AKTubularBells()
...
// //////////////////////////////
    ...
    func play() {
        self.instrument.trigger(frequency: self.midiNote.midiNoteToFrequency())
        self.envelope.start()
    }
